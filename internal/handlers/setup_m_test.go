...
// 	app.UseCache = true // since it's test
...
// 	// mux.Use(NoSurf) // comment this out for handlers_test.go to run
// 	mux.Use(SessionLoad)
...
// 	mux.Get("/admin/reservations-new", Repo.AdminNewReservatons)
// 	mux.Get("/admin/reservations-all", Repo.AdminAllReservatons)
