...
// Reservation rends the make a reservation page and displays form
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		...
		// http.Error(w, "my own error message", http.StatusSeeOther) fix this in tests!
		render.Template(w, r, "make-reservation.page.tmpl", &models.TemplateData{
			Form: form,
			Data: data,
			StringMap: stringMap,
...
func (m *Repository) ChooseRoom(w http.ResponseWriter, r *http.Request) {
	// roomID, err := strconv.Atoi(chi.URLParam(r, "id")) // using chi.URLParam()
	exploded := strings.Split(r.RequestURI, "/") // Using build in method with split
...
// BookRoom takes your parameters, builds a sessional variable, and takes user to make res screen
...
func (m *Repository) AdminNewReservatons(w http.ResponseWriter, r *http.Request) {
...
// AdminReservations shows all new reservations in admin tool
func (m *Repository) AdminAllReservatons(w http.ResponseWriter, r *http.Request) {
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	nextMonth := next.Format("01") // 01 gives a two-digit month
...
// AdminPostShowReservation shows details of a reservation
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// that doesn't exist in our posted data, and if the restriction id > 0, then it is a block we need to remove.
